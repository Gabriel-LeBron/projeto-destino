      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link to="/" className="hover:text-blue-900 transition">Início</Link></li>
            <li><Link to="/contato" className="hover:text-blue-900 transition">Contato</Link></li>
            <li><Link to="/login" className="hover:text-blue-900 transition">Login</Link></li>
            <li><Link to="/cadastro" className="hover:text-blue-900 transition">Cadastro</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="hover:text-blue-900 transition text-xl">🌐</a>
            <a href="#" className="hover:text-blue-900 transition text-xl">📘</a>
            <a href="#" className="hover:text-blue-900 transition text-xl">📸</a>
          </div>
        </div>
