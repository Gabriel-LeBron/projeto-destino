    ...
    <div className='flex flex-col min-h-screen bg-gradient-to-br from-white to-sky-200'>
      ...
      <main className='flex-grow p-4 md:p-8'>
        ...
        <section className="mt-7">
          <h2 className='text-center text-3xl font-bold mb-9'>Confira Nossos Pacotes</h2>
      ...
      <footer className='text-center p-6 bg-sky-300/30 text-gray-700 mt-10'>
        <span>&copy; PAULA VIAGENS E TURISMO - Todos os direitos reservados.</span>
      </footer>
    </div>
  );
}