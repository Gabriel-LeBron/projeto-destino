            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                ...
                <div className="text-sm text-gray-500 mt-1">
                  Preço individual: {formatarPreco(pacote.preco)}
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-4 px-6 rounded-xl font-bold text-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl transform active:scale-95"
              >
                Reservar Agora
              </button>
