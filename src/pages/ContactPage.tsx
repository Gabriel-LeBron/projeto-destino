      ...
      <section className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-6 py-20 gap-10">
        ...
        <div className="flex flex-col space-y-6 md:w-1/2">
          ...
          <p className="text-gray-700 leading-relaxed">
            Precisa de ajuda para planejar sua viagem, tirar dúvidas sobre pacotes
            ou fazer uma parceria? Nossa equipe está pronta para te atender.
          </p>
          ...
          <div className="flex space-x-4 text-2xl mt-4">
            <a href="#" className="hover:text-[#ff7300] transition">🌐</a>
            <a href="#" className="hover:text-[#ff7300] transition">📘</a>
            <a href="#" className="hover:text-[#ff7300] transition">📸</a>
          </div>
        </div>
